...
# VARIABLES
categories = ['bar', 'bedroom', 'dining', 'entertainment', 'home-decor', 'living-room', 'office', 'tables', 'youth']
...
for category in categories:
    ...
    # print(soup.find_all('li', class_='item product product-item'))
    # print(soup.find_all('ul', class_='items pages-items')[0])
